...
verify all four pieces exist, or green PRs sit CLEAN silently until the delivery timeout
...
`main`; the repo setting `allow_auto_merge` is true (Mergify queues by arming GitHub
